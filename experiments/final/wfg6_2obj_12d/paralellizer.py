...
ref = func(np.ones_like(x_limits[0]), k, n_obj)
...
for n in range(0, 3):
    optimisers += [SmsEgo(test_function, x_limits, surrogate, n_initial=10, budget=100, seed=n, ei=True, log_dir="./log_data", ref_vector=ref, cmaes_restarts=0),
                  ...
                  Sms_Saf(test_function, x_limits, surrogate, n_initial=10, budget=100, seed=n, ei=False, log_dir="./log_data", ref_vector=ref, cmaes_restarts=0), 
                  Saf_Sms(test_function, x_limits, surrogate, n_initial=10, budget=100, seed=n, ei=False, log_dir="./log_data",  ref_vector=ref, cmaes_restarts=0)]
...
#pool.close()
#print("finished")
opt = Saf(test_function, x_limits, surrogate, n_initial=10, budget=100, seed=2, ei=True, log_dir="./log_data", ref_vector=ref, cmaes_restarts=0)
opt.optimise()
