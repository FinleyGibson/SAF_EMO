...
if __name__ == "__main__":
    ...
    for n in [5]: #[ 1, 4, 5]
        optimisers += [Mpoi(objective_function=test_function, limits=x_limits, surrogate=surrogate, n_initial=10, seed=4, budget=budget, cmaes_restarts=0),
                      Mpoi(objective_function=test_function, limits=x_limits, surrogate=surrogate, n_initial=10, seed=10, budget=budget, cmaes_restarts=0)]
