...
optimisers = [SmsEgo(objective_function=objective_function, limits=limits, surrogate=multi_surrogate, n_initial=10, budget=budget, seed=2, ei=True, log_dir=log_dir, cmaes_restarts=cmaes_restarts, log_interval=5),
              ...
              Mpoi(objective_function=objective_function, limits=limits, surrogate=multi_surrogate, n_initial=10, seed=4, budget=budget, cmaes_restarts=cmaes_restarts ,log_interval=5),
              Mpoi(objective_function=objective_function, limits=limits, surrogate=multi_surrogate, n_initial=10, seed=6, budget=budget, cmaes_restarts=cmaes_restarts ,log_interval=5)]
