...
if __name__ == "__main__":
    ...
    optimisers += [SmsEgo(test_function, x_limits, surrogate, n_initial=10, budget=budget, seed=0, ei=True, log_dir="./log_data", cmaes_restarts=0)]
    optimisers += [Mpoi(objective_function=test_function, limits=x_limits, surrogate=surrogate, n_initial=10, seed=1, budget=budget, cmaes_restarts=0)]
